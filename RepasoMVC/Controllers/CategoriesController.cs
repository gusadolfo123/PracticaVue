...
namespace RepasoMVC.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        [HttpPost]
        public JsonResult CreateCategory([Bind(Include = "CategoryID,Description")] Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                return Json(new { category, success = true }, JsonRequestBehavior.AllowGet);
            }

            return Json(new { category, success = false }, JsonRequestBehavior.AllowGet);
        }
